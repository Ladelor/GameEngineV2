...
int main(void)
{
    ...
    Shaders shaders = Shaders("Source/simpleVertexShader.vshader", "Source/simpleFragmentShader.fshader");
    ...
    Texture myTexture = Texture("Otherstuff/uvtemplate.DDS");
    GLuint TextureID = myTexture.loadTexture();
