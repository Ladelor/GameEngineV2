...
GLuint Shaders::LoadShaders()
{
	...
	if (VertexShaderStream.is_open()) {
		...
		std::cout << "Impossible to open %s. Are you in the right directory ? Don't forget to read the FAQ!" << std::endl;
		getchar();
		return 0;
	}
	...
	std::cout << "Compiling shader: " << _vertexFilePath << std::endl;
	...
	std::cout << "Compiling shader: " << _fragmentFilePath << std::endl;
